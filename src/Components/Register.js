...
function Register(){
    ...
    const [otpSuccessMsg,setOtpSuccessMsg]=useState('hello');
    const mobileRegex=/^[6-9]{1}[0-9]{9}$/;

    let recapthaVerifier;
    const sendOtp=async()=>{
        if(mobileRegex.test(phone)){
            setErrorMessage('')
            try{
                recapthaVerifier = await new RecaptchaVerifier(auth,'recaptcha',{size: 'invisible'});
    ...
    const sendOTPWithPhoneNumber = () => {
        ...
        signInWithPhoneNumber(auth, '+916379185147', recapthaVerifier)
        .then((confirmationResult) => {
            setCurrentUser(confirmationResult);
            let firstTwo=phone.slice(0,2);
            let middlesixEight=phone.slice(2,8).replace(/[0-9]/g,'X');
    ...
    const handlePhone = (value, country) => {
        ...
        setCountryCode(country.dialCode); // Store the selected country code
    };
    ...
    useEffect(()=>{
        if(postOfficeUrl && postOfficeUrl.length>0){
            $('#form-state').val(postOfficeUrl[0].State);
    ...
    useEffect(()=>{
        ...
        if(totalAdded>1){
            ...
            if(value!==''){
                ...
                for(let i of postOfficeUrl){
                    if(i.Name===value){
                        $('#form-taluk').val(i.Taluk);
                        $('#form-district').val(i.District);
                        $('#form-state').val(i.State);
                        found=true;
                    }
                }
                if(!found){
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='every-form-div'>
                            <div>
                                ...
                                <input type="text" id='form-firstname' className='input-field'  name='firstname'  value={firstname} onChange={(e) => setFirstName(e.target.value)} /><br />
                            </div>
                            <div>
                                <label htmlFor='form-lastname' className='form-label' required>Last Name</label>
                                <input type="text" id='form-lastname' className='input-field'  name='lastname'  value={lastname}  onChange={(e) => setLastName(e.target.value)} /><br />
                            </div>
                        </div>
                        ...
                        <div className='every-form-div'>
                            <div>
                                ...
                                <input type="date" id='form-dob' className='input-field'  name='dob'  value={dob}  onChange={(e) => setDob(e.target.value)} /><br />
                            </div>
                            <div>
                                <label htmlFor='form-gender' className='form-label' required>Gender</label>
                                <input type="text" id='form-gender' className='input-field'  name='gender'  value={gender}  onChange={(e) => setGender(e.target.value)} /><br />
                            </div>
                        </div>
                        ...
                        <div className='every-form-div'>
                            <div>
                                ...
                                <input type="email" id='form-email' className='input-field'  name='email'  value={email}  onChange={(e) => setEmail(e.target.value)} /><br />
                            </div>
                        </div>
                        ...
                        <div className='phone-div-form'>
                            ...
                            <div id='phone-div-form-child1'>
                                ...
                                <input type="phone" id='form-phone' className='input-phone'  name='pass'  value={phone}  placeholder='Enter Mobile Number' onChange={(e) => setPhone(e.target.value)} /><br />
                        ...
                        <div className='success-msg' value={otpSuccessMsg}></div>
                        ...
                        <div className='every-form-div'>
                            <div>
                                ...
                                <input type="password" id='form-pass' className='input-field'  name='pass'  value={password}  onChange={(e) => setPassword(e.target.value)} /><br />
                            </div>
                            <div>
                                <label htmlFor='form-repass' className='form-label' required>Retype Password</label>
                                <input type="password" id='form-repass' className='input-field'  name='repass'  value={repassword}  onChange={(e) => setRepassword(e.target.value)} /><br />
                            </div>
                        </div>
                        ...
                        <div className='every-form-div'>
                            ...
                            <div>
                                <label htmlFor='form-address' className='form-label' required>Home Address</label>
                                <input type="text" id='form-address' className='input-field'  name='address'  value={homeaddress}  onChange={(e) => setHomeaddress(e.target.value)} /><br />
                            </div>
                        </div>
